...
from trainers_Sample import FinetuneTrainer_Time
...
def main():
    ...
    # model args
    parser.add_argument("--model_name", default='Finetune_sample_remaining', type=str)
    ...
    trainer = FinetuneTrainer_Time(model, train_dataloader, eval_dataloader,test_dataloader, args)
